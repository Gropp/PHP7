...
#USAR ESSE $aluno = new DBTbUsuarios();
//IMPORTANTE:
...
#USAR ESSE $aluno->setDeslogin("Claudio José da Silva"); //VARCHAR(64)
#USAR ESSE $aluno->setDessenha("89078%@!"); //VARCHAR(256)
...
#USAR ESSE $aluno->insert(); //SEM O METODO CONSTRUTOR
