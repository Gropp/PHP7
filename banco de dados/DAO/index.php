...
//VAMOS USAR UM METODO STATIC DENTRO DA CLASSE DBTbUsuarios - ESSE METODO NAO MANIPULA DIRETAMENTE ATRIBUTOS DA CLASSE, ENTAO A VANTAGEM É QUE PODEMOS CHAMA-LO SEM INSTANCIAR A CLASSE!!!! É UM METODO PODEROSO, FUNCIONA DENTRO E FORA DA CLASSE
//CARREGA UMA LISTA DE USUARIOS
//Atribui a uma variavel o retorno da CLASSE::METODO();
//PODEMOS PASSAR NOS PARAMETROS A COLUNA DE ORDENACAO - NUMERO OU NOME DA COLUNA
$lista = DBTbUsuarios::getList("deslogin");
echo json_encode($lista);

//IMPORTANTE:
//SELECT PROCURANDO UMA STRING DENTRO DO IDLOGIN
//METODO STATICO SEARCH QUE BUSCA UMA STRING DENTRO DO CAMPO DESLOGIN
...
#$search = DBTbUsuarios::search("oo");
#echo json_encode($search);

//IMPORTANTE: 
//TESTA SE O USUARIO E A SENHA SAO VALIDOS
//CARREGA UM USUARIO USANDO O LOGIN E A SENHA - A CLASSE NAO É ESTATICA, TEM QUE SER INSTANCIADA
#$usuario = new DBTbUsuarios();
//PASSAR UM LOGIN E UM USUARIO VALIDOS
#$usuario->login("Fernando Solon","quety12@#");
#echo $usuario;
...
##$aluno = new DBTbUsuarios(); /SEM O METODO CONSTRUTOR
//USAR ESSE
#$aluno = new DBTbUsuarios("Claro Certeiro","reFEG2332!@#");
//IMPORTANTE:
//COM A INCLUSAO DO METODO CONSTRUTOR, ESSAS ATRIBUICOES VAO PARA O ARGUMENTO DA CHAMADA DO METODO INSERT!!!!
//FIXME: O METODO CONSTRUTOR NAO DEU CERTO!!!!
//CORRIGIDO - O PARAMETRO TEM QUE SER COLOCADO NA INSTANCIA DO METODO E NAO NA CHAMADA DO METODO INSERT
##$aluno->setDeslogin("Claudio José da Silva"); //VARCHAR(64)
##$aluno->setDessenha("89078%@!"); //VARCHAR(256)
...
//USAR ESSE
#$aluno->insert(); //CHAMA O METODO INSERT
#aluno->insert("aluno","4lun0"); //ERRADO - O METODO CONSTRUCTOR É ATIVADO COM O INSTANCIAMENTO DA CLASSE, ENTAO TEM QUE PASSAR OS PARAMETROS NO NEW E NAO NO INSERT!!!
...
//CARREGA O REGISTRO QUE VOCE QUER ALTERAR PARA CARREGAR O ATRIBUTO IDUSUARIO, QUE É ATRIBUIDO DURANTE O SELECT - "idusuario" é um usuario qualquer!
#$alter->loadById(10);
...
#$alter->update("Sergei Prokofiev","MUS1C@CL@SS!C@");
#echo $alter;

//IMPORTANTE:
//DELETAR UM USUARIO
//INSTANCIA A CLASSE DBTBUSUARIOS
#$deletar = new DBTbUsuarios();
//SELECIONA O USUARIO A SER DELETADO - "idusuario" é um usuario qualquer!
#$deletar->loadById(12);
//UMA VEZ CARREGADO O USUARIO SELECIONADO, TODAS OS ATRIBUTOS ESTAO PREENCHIDOS
//ENTAO É SO CHAMAR O METODO DELETE PARA QUE ESSES ATRIBUTOS SEJAM OS PARAMETROS DO METODO DELETAR
#$deletar->delete();
//MOSTRAMOS ENTAO OS VALORES DOS ATRIBUTOS DA CLASSE APOS A ACAO DELETAR
#echo $deletar;